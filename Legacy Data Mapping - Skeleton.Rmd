---
title: "Legacy Data Mapping - Skeleton"
author: "Bryson Torgovitsky"
date: "1/27/2025"
output: 
  github_document
---

```{r setup, include=FALSE, mute=TRUE}
...
```{r Database1, fig.width=12, fig.height=10}
...
```{r Database2, fig.width=12, fig.height=10}
...
```{r Database3, fig.width=12, fig.height=10}
...
```{r pressure, fig.width=12, fig.height=10}
...
```{r Further refinement by species, fig.width=12, fig.height=10}
...
```{r Isolating species of interest, fig.width=12, fig.height=10}
...
Note that the `echo = TRUE` parameter was added to the code chunk to enable printing of the R code that generated the plot.`eval = MUTE` was added to enable knitting of this file.
